...
/* appearance */
static const unsigned int frfresh_rate        = 60;   /* matches dwm's mouse event processing to your monitor's refresh rate for smoother window interactions */
...
static const Key keys[] = {
	...
	{ MODKEY|Mod1Mask,                       XK_s,      spawn,          SHCMD ("orca")},
	{ Mod1Mask|ShiftMask,                       XK_s,      spawn,          SHCMD ("pkill orca")},
	...
	{ MODKEY,                       XK_p,      spawn,          SHCMD ("flameshot gui -p ~/Pictures/Screenshots")},
	{ MODKEY|ShiftMask,                       XK_p,      spawn,          SHCMD ("flameshot full -p ~/Pictures/Screenshots")},
